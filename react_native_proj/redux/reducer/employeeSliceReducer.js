...
export const createEmployee = createAsyncThunk("employee/createEmployee", async (userId) => {
  try {
...
export const getEmployee = createAsyncThunk("employee/getEmployee", async (userId) => {
  try {
    const response = await axios.get(api + `employees?profile=${userId}&populate=deep,3`);
...
export const updateEmployee = createAsyncThunk("employee/updateEmployee", async (data) => {
    try {
      const response = await axios.put(api + `employees/${data.employeeId}?populate=deep,3`, {
        data: data.bodyData
      });
  ...
  export const uploadImage = createAsyncThunk("employee/uploadImage", async (data) => {
    try {
